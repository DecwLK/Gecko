...
public class SystemInspectorBuilder extends AbstractInspectorBuilder<SystemViewModel> {
    ...
    public SystemInspectorBuilder(
        ...
        // Open system button
        addInspectorElement(
                new InspectorOpenSystemButton(actionManager, editorViewModel, viewModel));
        ...
        addInspectorElement(
                new InspectorAddVariableButton(actionManager, viewModel, Visibility.INPUT));
        // TODO
        addInspectorElement(new InspectorVariableList());

        addInspectorElement(new InspectorLabel("L: Output"));
        addInspectorElement(
                new InspectorAddVariableButton(actionManager, viewModel, Visibility.OUTPUT));
        // TODO
        addInspectorElement(new InspectorVariableList());
    }
}
