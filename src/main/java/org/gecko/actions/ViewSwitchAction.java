...
/** A concrete representation of an {@link Action} that switches between {@link EditorViewModel}s depending on whether or not the current {@link EditorViewModel} is an automaton view.  */
