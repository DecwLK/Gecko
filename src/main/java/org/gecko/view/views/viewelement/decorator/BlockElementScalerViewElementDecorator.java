...
/** A concrete representation of a {@link ViewElementDecorator} following the decorator pattern for scaling purposes. It holds a reference to a {@link Group} containing the drawn target and a list of {@link ElementScalerBlock}s, one for each edge point of the decorator. */
