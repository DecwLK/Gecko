...
/** A concrete representation of an {@link Action} that changes the postcondition of a {@link ContractViewModel}, which it holds a reference to. Additionally holds the old and new {@link String postcondition}s of the contract for undo/redo purposes. */
