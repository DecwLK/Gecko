...
/** An abstract representation of a {@link Pane} view element, that is an element with a rectangular shape in a Gecko project. Contains a list of {@link Point2D edge point}s. */
