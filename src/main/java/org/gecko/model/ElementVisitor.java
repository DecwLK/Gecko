...
public interface ElementVisitor {
    ...
    void visit(SystemConnection systemConnection) throws ModelException;

    void visit(Variable variable) throws ModelException;

    void visit(System system) throws ModelException;

    void visit(Region region) throws ModelException;

    void visit(Edge edge) throws ModelException;
}
