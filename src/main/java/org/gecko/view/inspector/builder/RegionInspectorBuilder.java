...
/** Represents a type of {@link AbstractInspectorBuilder} of an {@link Inspector} for a {@link RegionViewModel}. Adds to the list of {@link org.gecko.view.inspector.element.InspectorElement InspectorElement}s, which are added to a built {@link org.gecko.view.inspector.Inspector Inspector}, the following: an {@link InspectorRegionColorItem} and an {@link InspectorContractItem}. */
