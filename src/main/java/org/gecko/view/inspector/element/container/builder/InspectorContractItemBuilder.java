...
public class InspectorContractItemBuilder extends AbstractInspectorContainerBuilder {

    @Override
    public List<InspectorElement<?>> getElements() {
        return null;
    }
    ...
    @Override
    public AbstractInspectorContainerItem build() {
        return null;
    }
}
