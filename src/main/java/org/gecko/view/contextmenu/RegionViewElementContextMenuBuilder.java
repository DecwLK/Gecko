...
/** Represents a type of {@link ViewContextMenuBuilder} for a {@link ContextMenu} specific to a {@link org.gecko.view.views.viewelement.RegionViewElement RegionViewElement}. Contains {@link MenuItem}s that run operations like deleting the edge. */
