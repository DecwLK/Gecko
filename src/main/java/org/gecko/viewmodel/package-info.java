 ...
 * {@link org.gecko.viewmodel.BlockViewModelElement BlockViewModelElements}, which are
 * {@link org.gecko.viewmodel.Renamable}, and {@link org.gecko.viewmodel.ConnectionViewModel ConnectionViewModels}. The
 * {@link org.gecko.viewmodel.ViewModelFactory} is responsible for creating instances of each of these elements and the
 * {@link org.gecko.viewmodel.PositionableViewModelElementVisitor} allows access to them. Additionally, the
 * {@link org.gecko.viewmodel.EditorViewModel} models the currently displayed editor view and the
