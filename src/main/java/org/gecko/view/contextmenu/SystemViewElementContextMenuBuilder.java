...
/** Represents a type of {@link ViewContextMenuBuilder} for a {@link ContextMenu} specific to a {@link org.gecko.view.views.viewelement.SystemViewElement SystemViewElement}. Contains {@link MenuItem}s that run operations like opening or deleting the system. */
