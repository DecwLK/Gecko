...
/** A concrete representation of an {@link Action} that changes the name of a {@link Renamable}.  Additionally, holds the old and new {@link String name}s of the element. */
