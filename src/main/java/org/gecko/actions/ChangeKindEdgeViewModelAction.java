...
/** Represents a type of {@link Action} that changes the {@link Kind} of an {@link EdgeViewModel}, which it holds a references to. Additionally, holds the old and new {@link Kind}s of the edge for undo/redo purposes. */
