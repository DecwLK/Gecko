...
/** Provides methods used in the visualization of an element in the view. Any such view element corresponds to a view-model element, which is why the interface is generic, encapsulating a type of {@link PositionableViewModelElement}. Concrete visitors must implement this interface to define specific behavior for each view element. */
